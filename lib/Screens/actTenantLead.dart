...
class RentScreen extends StatefulWidget {
  Map resdata;
  RentScreen({Key key,this.resdata}) : super(key: key);
  @override
  ...
  void initState() {
   ...
   //   var value = 'bearer PgEPgnkqVTPz27SkCtakPzVUTmBA38Uof4aYflUkcGWKnDsvxdHGEN2hU33SrUfGzlLh8-3-JEdKiC9wp3OPm8j58-QDcxWvYYiCTu32qZevWYUgBf4mtKGb7fRCe1VKPsuaRGtPF7qP15gZ4V67fDYtCD8QDLv66sLKCTXkEQgO5ZY0-AylwNt-YDcbnjFO2ffagbZ8aIBxWukmTZTLekO32kbbZklmvL-3ltD2a3MqncKHplEf6exFeo8qSWDGwAdyMXWvLYhRVRz5dYmRYuz8ePwdabxB6wXB3X78gPJ6KdORf9IC8kYQBjyZ-vD0';
      ...
      // headers: {"Authorization": "Some token"}
       var url = 'https://mobileapi.therecrm.com/api/RentLeads/?uID=$id';
      ...
      'Authorization': '$value',
         ...
         if (response.statusCode == 200) {
          ...
          .setCustomKey('Active Tenant List', "API Failed to Load Response_Value");
      FirebaseCrashlytics.instance
          .log("Api Calling method is failed for ActiveTenantList");
                       Navigator.push(
...
var status = data[index]['Status'].toString();
var site = status.substring(0, 4);
var visit = status.substring(4);
return Center(
child: Padding(
